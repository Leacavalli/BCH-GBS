...
# Add p-value row
p_val_infant_row <- c("p-value", p_val_infant_Hb, p_val_infant_WBC, p_val_infant_Leukocytosis, p_val_infant_Leukopenia, p_val_infant_platelet, p_val_infant_ANC, p_val_infant_Neutropenia)
...
# Add p-value row
p_val_LOD_row <- c("p-value", p_val_LOD_Hb, p_val_LOD_WBC, p_val_LOD_Leukocytosis, p_val_LOD_Leukopenia, p_val_LOD_platelet, p_val_LOD_ANC, p_val_LOD_Neutropenia)
# Bind both rows to the table
...
# Add p-value row
p_val_ICU_row <- c("p-value", p_val_ICU_Hb, p_val_ICU_WBC, p_val_ICU_Leukocytosis, p_val_ICU_Leukopenia, p_val_ICU_platelet, p_val_ICU_ANC, p_val_ICU_Neutropenia)
# Bind both rows to the table
...
# Add p-value row
p_val_Meningitis_row <- c("p-value", p_val_Meningitis_Hb, p_val_Meningitis_WBC, p_val_Meningitis_Leukocytosis, p_val_Meningitis_Leukopenia, p_val_Meningitis_platelet, p_val_Meningitis_ANC, p_val_Meningitis_Neutropenia)
# Bind both rows to the table
Table1_4 <- rbind(Table1_4, or_Meningitis_row, p_val_Meningitis_row)
```

```{r}
hematological_correlates_severe_disease_df <- rbind(data.frame(t(Table1_1)), 
      data.frame(t(Table1_2)), 
      data.frame(t(Table1_3)), 
      data.frame(t(Table1_4)))

# Save
xtable_hematological_correlates_severe_disease_df <- xtable(hematological_correlates_severe_disease_df)
xtable_hematological_correlates_severe_disease_df
```
...
df_Infants_vs_Older_CC <- data.frame(Gene= str_replace(row.names(coef(summary(model_Infants_vs_Older_CC))) [-1], "as.factor\\(CC\\)", "CC"),
...
# Load data 
Infants_vs_Older_Output_GAS <- read.delim("~/GitHub/BCH-GBS/1. Bioinformatic_Analysis/Pyseer/Infants_vs_Older/Output_GAS.txt") 
...
print(xtable_Infants_vs_Older, include.rownames = FALSE,
      file = "~/GitHub/BCH-GBS/1. Bioinformatic_Analysis/Pyseer/Infants_vs_Older/Infants_vs_Older_table.tex")
```
...
# Load data 
LOD_vs_VLOD_Output_GAS <- read.delim("~/GitHub/BCH-GBS/1. Bioinformatic_Analysis/Pyseer/LOD_vs_VLOD/Output_GAS.txt") 
...
print(xtable_LOD_vs_VLOD, include.rownames = FALSE,
      file = "~/GitHub/BCH-GBS/1. Bioinformatic_Analysis/Pyseer/LOD_vs_VLOD/LOD_vs_VLOD_table.tex")



# check association with ICU and Meningitis
## ICU
model_LOD_vs_VLOD_ICU     <- glm(LOD ~ as.factor(ICU),data_LOD, family = binomial)
OR_LOD_vs_VLOD_ICU <- round(exp(coef(summary(model_LOD_vs_VLOD_ICU))[-1, 1]), 2)
OR_CI_low_LOD_vs_VLOD_ICU <- round(exp(coef(summary(model_LOD_vs_VLOD_ICU))[-1, 1] - 1.96 * coef(summary(model_LOD_vs_VLOD_ICU))[-1, 2]), 2)
OR_CI_high_LOD_vs_VLOD_ICU <- round(exp(coef(summary(model_LOD_vs_VLOD_ICU))[-1, 1] + 1.96 * coef(summary(model_LOD_vs_VLOD_ICU))[-1, 2]), 2)
p_LOD_vs_VLOD_ICU <- round((coef(summary(model_LOD_vs_VLOD_ICU))[-1, 4]), 4)
df_LOD_vs_VLOD_ICU <- data.frame(Gene= str_replace(row.names(coef(summary(model_LOD_vs_VLOD_ICU))) [-1], "as.factor\\(ICU\\)", "ICU"),
                                     "Crude OR" = OR_LOD_vs_VLOD_ICU,
                                     "(95% CI)" = paste0("(", OR_CI_low_LOD_vs_VLOD_ICU, " ;", OR_CI_high_LOD_vs_VLOD_ICU, ")"), 
                                     "Crude P-value" = p_LOD_vs_VLOD_ICU)
colnames(df_LOD_vs_VLOD_ICU) <- c("Gene" ,"Crude OR", "(95% CI)", "Crude P-value")
df_LOD_vs_VLOD_ICU

## Meningitis
model_LOD_vs_VLOD_Meningitis     <- glm(LOD ~ as.factor(Meningitis),data_LOD, family = binomial)
OR_LOD_vs_VLOD_Meningitis <- round(exp(coef(summary(model_LOD_vs_VLOD_Meningitis))[-1, 1]), 2)
OR_CI_low_LOD_vs_VLOD_Meningitis <- round(exp(coef(summary(model_LOD_vs_VLOD_Meningitis))[-1, 1] - 1.96 * coef(summary(model_LOD_vs_VLOD_Meningitis))[-1, 2]), 2)
OR_CI_high_LOD_vs_VLOD_Meningitis <- round(exp(coef(summary(model_LOD_vs_VLOD_Meningitis))[-1, 1] + 1.96 * coef(summary(model_LOD_vs_VLOD_Meningitis))[-1, 2]), 2)
p_LOD_vs_VLOD_Meningitis <- round((coef(summary(model_LOD_vs_VLOD_Meningitis))[-1, 4]), 4)
df_LOD_vs_VLOD_Meningitis <- data.frame(Gene= str_replace(row.names(coef(summary(model_LOD_vs_VLOD_Meningitis))) [-1], "as.factor\\(Meningitis\\)", "Meningitis"),
                                     "Crude OR" = OR_LOD_vs_VLOD_Meningitis,
                                     "(95% CI)" = paste0("(", OR_CI_low_LOD_vs_VLOD_Meningitis, " ;", OR_CI_high_LOD_vs_VLOD_Meningitis, ")"), 
                                     "Crude P-value" = p_LOD_vs_VLOD_Meningitis)
colnames(df_LOD_vs_VLOD_Meningitis) <- c("Gene" ,"Crude OR", "(95% CI)", "Crude P-value")
df_LOD_vs_VLOD_Meningitis
...
```{r}
# Load data 
LOD_vs_VLOD_cont_Output_GAS <- read.delim("~/GitHub/BCH-GBS/1. Bioinformatic_Analysis/Pyseer/LOD_vs_VLOD/Continuous/Output_GAS_lmm_continuous.txt") 
...
print(xtable_LOD_vs_VLOD_cont, include.rownames = FALSE,
      file = "~/GitHub/BCH-GBS/1. Bioinformatic_Analysis/Pyseer/LOD_vs_VLOD/Continuous/LOD_vs_VLOD_cont_table.tex")
```
...
# Load data 
ICU_Infants_Output_GAS <- read.delim("~/GitHub/BCH-GBS/1. Bioinformatic_Analysis/Pyseer/ICU_Infants/Output_GAS.txt") 
...
print(xtable_ICU_Infants, include.rownames = FALSE,
      file = "~/GitHub/BCH-GBS/1. Bioinformatic_Analysis/Pyseer/ICU_Infants/ICU_Infants_table.tex")
```
...
# Load data 
Meningitis_Infants_Output_GAS <- read.delim("~/GitHub/BCH-GBS/1. Bioinformatic_Analysis/Pyseer/Meningitis_Infants/Output_GAS.txt") 
...
print(xtable_Meningitis_Infants, include.rownames = FALSE,
      file = "~/GitHub/BCH-GBS/1. Bioinformatic_Analysis/Pyseer/Meningitis_Infants/Meningitis_Infants_table.tex")
```
...
# Load data 
Neutropenia_Infants_Output_GAS <- read.delim("~/GitHub/BCH-GBS/1. Bioinformatic_Analysis/Pyseer/Neutropenia_Infants/Output_GAS.txt") 
...
print(xtable_Neutropenia_Infants, include.rownames = FALSE,
      file = "~/GitHub/BCH-GBS/1. Bioinformatic_Analysis/Pyseer/Neutropenia_Infants/Neutropenia_Infants_table.tex")
```


## 2.6. Leukopenia Among infants
```{r} 
# Association with CCs
...
# Load data 
Leukopenia_Infants_Output_GAS <- read.delim("~/GitHub/BCH-GBS/1. Bioinformatic_Analysis/Pyseer/Leukopenia_Infants/Output_GAS.txt") 
...
print(xtable_Leukopenia_Infants, include.rownames = FALSE,
      file = "~/GitHub/BCH-GBS/1. Bioinformatic_Analysis/Pyseer/Leukopenia_Infants/Leukopenia_Infants_table.tex")
```
...
# Load data 
Leukocytosis_Infants_Output_GAS <- read.delim("~/GitHub/BCH-GBS/1. Bioinformatic_Analysis/Pyseer/Leukocytosis_Infants/Output_GAS.txt") 
...
print(xtable_Leukocytosis_Infants, include.rownames = FALSE,
      file = "~/GitHub/BCH-GBS/1. Bioinformatic_Analysis/Pyseer/Leukocytosis_Infants/Leukocytosis_Infants_table.tex")
```
